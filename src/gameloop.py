...
while True:
    ...
    while True:
        ...
        hud_text = "{}'s turn. Xs placed: {}. Os placed: {}. \n".format(lib.current_player_turn(main.turn_switch), main.xs_placed, main.os_placed)
        ...
        if main.grid[main.alphabet.index(alpha_val)][numeral_val-1] == main.pieces[1] or main.grid[main.alphabet.index(alpha_val)][numeral_val-1] == main.pieces[2]:
            ...
            grid = lib.modify_grid(main.alphabet.index(alpha_val), numeral_val, lib.current_player_turn(main.turn_switch), main.grid)
            status_message = ""
            break
    ...
    if main.pieces_placed_on_this_player_turn >= main.pieces_per_turn:
        lib.alternate_turns(main.turn_switch)
        grid = lib.ugly_powerup_placement_checks(main.grid)
